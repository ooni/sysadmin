...
BashOperator(pool='datacollector_disk_io', task_id='sanitised_s3_cp', bash_command='shovel_jump.sh', dag=dag)
...
dag.set_dependency('autoclaving', 'sanitised_s3_cp')

dag.set_dependency('sanitised_s3_cp', 'sanitised_check')
